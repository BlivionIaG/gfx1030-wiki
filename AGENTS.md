...
This repository is a **documentation-only wiki** for AMD gfx1030 (RDNA2 / Navi 21) GPUs, built with
[mdBook](https://rust-lang.github.io/mdBook/). There is **no application server, database, backend, or
automated test/lint suite** — the "product" is a static HTML site generated from Markdown.
