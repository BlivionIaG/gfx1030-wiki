...
| [`2kiss/flash-attention-rdna2`](https://github.com/2kiss/flash-attention-rdna2) | Independent RDNA2 FlashAttention kernel — `#vllm-rdna` Sep 22; **no gfx1030 bench yet**; org target remains in-tree `fa_rdna2` — [fork](../vllm/fork.md#attention) |
