...
| [`stylesuxx/amdvbflash`](https://github.com/stylesuxx/amdvbflash) | VBIOS dump/flash helper — only for restoring a **stock V620** image (e.g. cloud 200 MHz BIOS); **never** W6800 — [hardware](../setup/hardware.md#wrong-cloud-vbios) |
