...
| Flash-Next on **2×** V620, or any host that **must RAM/CPU-offload** | Prefer **llama.cpp** (`--n-cpu-moe`, `-ot …=CPU`) — `#vllm-rdna` Sep 14. Community 2-card IQ4_XS ~**25 t/s** / **150–200** PP — [recipe](../rdna2-speculative.md#flash-next-2x-iq4) |
