...
| Latest Flash-Next / `#17`+ HEAD | Host **venv** build | Clone [`opengfx1030/vllm-rdna`](https://github.com/opengfx1030/vllm-rdna) + [Host venv](host-venv.md). `#vllm-rdna` Sep 24: Hub tags **lag**; scripts under `rdna_extras/scripts/`. |
